          ...
          <form className="mt-8 space-y-6" onSubmit={handleRegister}>
                  ...
                  <div className="mt-3 space-y-3">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      <Link 
                        ...
                        className="inline-flex items-center justify-center px-4 py-2 border border-red-500 text-sm font-medium rounded-md text-white bg-red-500 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 focus:ring-offset-gray-900 transition-colors"
                      >
                        Sign in instead
                      </Link>
                      <Link 
                        href="/forgot-password"
                        className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium rounded-md text-red-400 hover:text-red-300 focus:outline-none focus:underline transition-colors"
                      >
                        Forgot password?
                      </Link>
                    </div>
            ...
            <div className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="btn-firecrawl-red w-full inline-flex items-center justify-center whitespace-nowrap rounded-[10px] text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 h-10 px-4"
              >
